...
namespace Aotenjo
{
    ...
    public class TileMaterialSugarCube : TileMaterialDessert
    {
        ...
        private static readonly int[] FanTable = { 5, 12, 18, 36 };
        ...
        {
            int idx = ((player.Level - 1) / 4) % 4;
            return string.Format(localizer(GetDescriptionLocalizeKey()), usesLeft, maxUses, FanTable[idx]);
        }
    }
}
